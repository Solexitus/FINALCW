...
gdjs.NewSceneCode.GDINSTRUCTIONSObjects1= [];
gdjs.NewSceneCode.GDINSTRUCTIONSObjects2= [];
gdjs.NewSceneCode.GDINSTRUCTIONSObjects3= [];
...
gdjs.NewSceneCode.mapOfGDgdjs_46NewSceneCode_46GDplayerBulletObjects1Objects = Hashtable.newFrom({"playerBullet": gdjs.NewSceneCode.GDplayerBulletObjects1});gdjs.NewSceneCode.eventsList0x85af7c = function(runtimeScene) {
...
}; //End of gdjs.NewSceneCode.eventsList0x85af7c
gdjs.NewSceneCode.eventsList0x7f11b4 = function(runtimeScene) {
...
}; //End of gdjs.NewSceneCode.eventsList0x7f11b4
gdjs.NewSceneCode.eventsList0x7f109c = function(runtimeScene) {
...
{ //Subevents
gdjs.NewSceneCode.eventsList0x7f11b4(runtimeScene);} //End of subevents
}
...
}; //End of gdjs.NewSceneCode.eventsList0x822c04
...
gdjs.NewSceneCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(8760716);
}
}}
if (gdjs.NewSceneCode.condition1IsTrue_0.val) {
/* Reuse gdjs.NewSceneCode.GDPlayerObjects1 */
...
{ //Subevents
gdjs.NewSceneCode.eventsList0x85af7c(runtimeScene);} //End of subevents
}
...
{
{gdjs.NewSceneCode.conditionTrue_1 = gdjs.NewSceneCode.condition1IsTrue_0;
gdjs.NewSceneCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(8326292);
}
}}
if (gdjs.NewSceneCode.condition1IsTrue_0.val) {
/* Reuse gdjs.NewSceneCode.GDPlayerObjects1 */
...
{ //Subevents
gdjs.NewSceneCode.eventsList0x7f109c(runtimeScene);} //End of subevents
}
...
gdjs.NewSceneCode.GDINSTRUCTIONSObjects1.createFrom(runtimeScene.getObjects("INSTRUCTIONS"));
/* Reuse gdjs.NewSceneCode.GDPlayerObjects1 */
...
}{for(var i = 0, len = gdjs.NewSceneCode.GDINSTRUCTIONSObjects1.length ;i < len;++i) {
    gdjs.NewSceneCode.GDINSTRUCTIONSObjects1[i].deleteFromScene(runtimeScene);
}
}}
...
}{gdjs.evtTools.sound.playSound(runtimeScene, "The Essential Retro Video Game Sound Effects Collection [512 sounds]\\The Essential Retro Video Game Sound Effects Collection [512 sounds] By Juhani Junkala\\Death Screams\\Alien\\sfx_deathscream_alien3.wav", false, 100, 1);
}}
...
}{gdjs.evtTools.sound.playSound(runtimeScene, "The Essential Retro Video Game Sound Effects Collection [512 sounds]\\The Essential Retro Video Game Sound Effects Collection [512 sounds] By Juhani Junkala\\Death Screams\\Alien\\sfx_deathscream_alien6.wav", false, 100, 1);
}}
...
gdjs.NewSceneCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(7414548);
}
}}
}
if (gdjs.NewSceneCode.condition2IsTrue_0.val) {
...
}{gdjs.evtTools.sound.playSound(runtimeScene, "The Essential Retro Video Game Sound Effects Collection [512 sounds]\\The Essential Retro Video Game Sound Effects Collection [512 sounds] By Juhani Junkala\\Death Screams\\Human\\sfx_deathscream_human4.wav", false, 100, 1);
}}
...
{
{gdjs.NewSceneCode.conditionTrue_1 = gdjs.NewSceneCode.condition2IsTrue_0;
gdjs.NewSceneCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(7416196);
}
}}
}
if (gdjs.NewSceneCode.condition2IsTrue_0.val) {
...
{
{gdjs.NewSceneCode.conditionTrue_1 = gdjs.NewSceneCode.condition1IsTrue_0;
gdjs.NewSceneCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(8528036);
}
}}
if (gdjs.NewSceneCode.condition1IsTrue_0.val) {
...
{
{gdjs.NewSceneCode.conditionTrue_1 = gdjs.NewSceneCode.condition1IsTrue_0;
gdjs.NewSceneCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(8529052);
}
}}
if (gdjs.NewSceneCode.condition1IsTrue_0.val) {
/* Reuse gdjs.NewSceneCode.GDPlayerObjects1 */
...
{ //Subevents
gdjs.NewSceneCode.eventsList0x822c04(runtimeScene);} //End of subevents
}
...
{
{gdjs.NewSceneCode.conditionTrue_1 = gdjs.NewSceneCode.condition1IsTrue_0;
gdjs.NewSceneCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(7141260);
}
}}
if (gdjs.NewSceneCode.condition1IsTrue_0.val) {
/* Reuse gdjs.NewSceneCode.GDBossObjects1 */
...
{for(var i = 0, len = gdjs.NewSceneCode.GDPlayerObjects1.length ;i < len;++i) {
    ...
    gdjs.NewSceneCode.GDPlayerObjects1[i].returnVariable(gdjs.NewSceneCode.GDPlayerObjects1[i].getVariables().getFromIndex(3)).add(5000 * gdjs.evtTools.common.getVariableNumber(runtimeScene.getGame().getVariables().get("BossTier")));
}
}{for(var i = 0, len = gdjs.NewSceneCode.GDBossObjects1.length ;i < len;++i) {
...
}{gdjs.evtTools.sound.playSound(runtimeScene, "The Essential Retro Video Game Sound Effects Collection [512 sounds]\\The Essential Retro Video Game Sound Effects Collection [512 sounds] By Juhani Junkala\\Death Screams\\Alien\\sfx_deathscream_alien1.wav", false, 100, 1);
}}
...
{
{gdjs.NewSceneCode.conditionTrue_1 = gdjs.NewSceneCode.condition1IsTrue_0;
gdjs.NewSceneCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(7189044);
}
}}
if (gdjs.NewSceneCode.condition1IsTrue_0.val) {
gdjs.NewSceneCode.GDbossBulletObjects1.createFrom(runtimeScene.getObjects("bossBullet"));
...
gdjs.NewSceneCode.GDINSTRUCTIONSObjects1.length = 0;
gdjs.NewSceneCode.GDINSTRUCTIONSObjects2.length = 0;
gdjs.NewSceneCode.GDINSTRUCTIONSObjects3.length = 0;
